...
function initCounters() {
    ...
    counters.forEach(c => {
        ...
        ScrollTrigger.create({
            trigger: c,
            start: 'top 85%',
            once: false, toggleActions: 'play none none reverse',
            onEnter: () => {
                gsap.to({ val: 0 }, {
...
function initScrollAnimations() {
    ...
    gsap.from('.cloud-tag', {
        ...
        scrollTrigger: { trigger: '.skills-cloud', start: 'top 92%', toggleActions: 'play none none reverse' }
    });
    ...
    gsap.from('.achievements-banner', {
        ...
        scrollTrigger: { trigger: '.achievements-banner', start: 'top 92%', toggleActions: 'play none none reverse' }
    });

    // Contact
    gsap.from('.contact-cta-text', {
        opacity: 0, x: -60, duration: 0.9, ease: 'power3.out',
        scrollTrigger: { trigger: '.contact-layout', start: 'top 90%', toggleActions: 'play none none reverse' }
    });
